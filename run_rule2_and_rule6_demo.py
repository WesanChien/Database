...
SP_NAME = "dbo.sp_DetectGranvilleRule2And6"
...
def fetch_results(cursor, stock_code, tolerance_days):
...
def main():
    ...
    tolerance_days = input("請輸入可忍受連續穿越 MA20 的天數（1~5）: ").strip()
    ...
    try:
        ...
        results = fetch_results(cursor, stock_code, tolerance_days)
